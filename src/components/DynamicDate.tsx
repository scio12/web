...
export const DynamicDate = ({ Timezone, alloc, allSchedulesLength, schedule }: Props) => {
    ...
    useEffect(() => {
        const setTime = async () => {
            ...
            if (isTheSameDay && !isEndOfDay) {
                const targetCard = document.querySelector(`[data-day="${schedule.day}"]`)
                ...
                const nextTargetCard = document.querySelector(`[data-day="${currentTime.weekday + 1}"]`)
